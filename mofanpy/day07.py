...
class Seq2Seq(keras.Model):
    ...
    def set_attention(self, x):
        ...
        # wrqp state by attention wrapper
    ...
    def train_logits(self, x, y, seq_len):
        # 拿到encoder 的 attention資訊和state  <---- self.set_attention()
        ...
        # 拿著所有快取的encoded state (attention memory) 和 encoder 最後一步產生state，放入decoder預測，得到加了注意力的output
...
def train():
    ...
    model = Seq2Seq(
        ...
        attention_layer_size=16, max_pred_len=11,
